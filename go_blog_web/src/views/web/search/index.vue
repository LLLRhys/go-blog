    ...
    <el-container class="main-content">
      <div class="container">
        <el-main>
          ...
          <el-table :data="articleTableData" :show-header="false" :row-style="{height: '200px'}">
            <el-table-column label="cover" width="200">
              <template #default="scope:{ row: any, column: any, $index: number }">
                <el-image style="width: 220px; height: 140px" :src="scope.row._source.cover" alt=""/>
              </template>
            </el-table-column>
            <el-table-column label="description">
              <template #default="scope:{ row: Hit<Article>, column: any, $index: number }">
                <div class="description" @click="handleArticleJumps(scope.row._id)">
                  <el-row class="title">
                    <el-tag v-if="scope.row._source.top" type="danger" size="small" effect="dark" style="margin-right:8px;">置顶</el-tag>
